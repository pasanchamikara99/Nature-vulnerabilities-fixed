...
export default function CartNew() {
  ...
  function saveBuyerReq() {
    ...
    axios
      .post("http://localhost:8002/buyerReq/add", newReq)
      .then(() => {
        console.log(newReq);
  ...
  const handleToken = (token) => {
    ...
    setStripeToken(token); // Make API call after setting the token
    ...
    axios
      ...
      .then((response) => {
        ...
        navigate("/success"); // Process the payment success/failure logic here
      })
      .catch((error) => {
      ...
      <div className="row">
          ...
          {cartItems.map((cartItemsData) => (
            <div>
              <div style={{ display: "inline-block" }}>
                <img
                  src={DOMPurify.sanitize(cartItemsData.image)}
              ...
              >
                ...
                <button
                  ...
                  onClick={() => removeFromCart(cartItemsData._id)}
                >
                  Remove From Cart
                </button>
              </div>
        ...
        <div className="col" style={{ position: "relative" }}>
          <form style={{ marginLeft: "10%", marginTop: "20px" }}>
            ...
            <div className="row md-12">
              <div className="col-md-12">
                <select className="form-control" onChange={handelDropdown}>
